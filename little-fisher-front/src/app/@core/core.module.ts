...
import { FisherAccountService } from './service/fisher.account.service.';
...
const DATA_SERVICES = [
  { provide: FisherAccountService, useClass: FisherAccountService },
  { provide: FisherConfig, useClass: FisherConfig },
